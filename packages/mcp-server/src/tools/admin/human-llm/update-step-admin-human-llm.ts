...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'post',
  httpPath: '/admin/human_llm/update_step',
  operationId: 'human_llm_update_step',
};

export const tool: Tool = {
  name: 'update_step_admin_human_llm',
  description:
...
export const handler = async (client: Structify, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.admin.humanLlm.updateStep(body));
};
