...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'post',
  httpPath: '/admin/next_action/add_action_training_datum',
  operationId: 'add_action_training_datum',
};
  ...
  inputSchema: {
    ...
    properties: {
      input: {
        ...
        required: ['all_steps', 'descriptor', 'extraction_criteria', 'previous_actions', 'seeded_kg'],
      },
      label: {
        type: 'string',
      },
...
export const handler = async (client: Structify, args: Record<string, unknown> | undefined) => {
  ...
  const response = await client.admin.nextAction.addTrainingDatum(body).asResponse();
