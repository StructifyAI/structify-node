...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/dataset/view_tables_with_relationships',
...
export const handler = async (client: Structify, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await maybeFilter(args, await client.datasets.viewTablesWithRelationships(body)),
  );
};
