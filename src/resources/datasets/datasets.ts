...
export class Datasets extends APIResource {
   ...
   */
  updateRelationship(
    body: DatasetUpdateRelationshipParams,
    options?: Core.RequestOptions,
  ): Core.APIPromise<void> {
    return this._client.post('/dataset/update_relationship', {
      body,
      ...options,
      headers: { Accept: '*/*', ...options?.headers },
    });
...
export namespace DatasetListResponse {
   ...
   * within the dataset.
   */
  export interface DatasetListResponseItem extends SharedAPI.DatasetDescriptor {
    id: string;
...
export interface DatasetUpdateRelationshipParams {
  dataset_name: string;
  ...
  new_merge_strategy?: RelationshipMergeStrategy | null;
}
