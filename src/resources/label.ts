...
export class Label extends APIResource {
   ...
   */
  update(body: LabelUpdateParams, options?: Core.RequestOptions): Core.APIPromise<string> {
    return this._client.post('/label/update', {
      body,
      ...options,
...
export interface LabelUpdateParams {
  ...
  steps: Array<LabelUpdateParams.Step>;
