...
describe('resource users', () => {
  ...
  test('impersonate: only required params', async () => {
    const responsePromise = client.admin.users.impersonate({
  ...
  test('impersonate: required and optional params', async () => {
    const response = await client.admin.users.impersonate({
      membership_id: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
    });
  });
});
