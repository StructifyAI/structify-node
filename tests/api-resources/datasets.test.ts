...
describe('resource datasets', () => {
  ...
  test('retrieveInfo: only required params', async () => {
    const responsePromise = structify.datasets.retrieveInfo({ name: 'string' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('retrieveInfo: required and optional params', async () => {
    const response = await structify.datasets.retrieveInfo({ name: 'string' });
  });
