...
describe('resource admin', () => {
  ...
  test('deleteCatalog', async () => {
    const responsePromise = client.connectorCatalog.admin.deleteCatalog(
  ...
  test('deleteCatalog: request options instead of params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(
      client.connectorCatalog.admin.deleteCatalog('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', {
